...
const challengeResponseCheck: ValidatedEventAPIGatewayProxyEvent<void> = async (event): Promise<any> => {
  try {
    let crcToken = event.pathParameters ? event.pathParameters.crc_token : '';
